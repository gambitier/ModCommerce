...
namespace UserService.API.ErrorHandling;

/// <summary>
/// Custom result profile for the UserService.API that transforms FluentResults errors into standard HTTP responses.
