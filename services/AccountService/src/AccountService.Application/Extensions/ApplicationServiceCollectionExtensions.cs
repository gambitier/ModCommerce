...
{
    private const string ApplicationServicesNamespace = "AccountService.Application.Services";
    private const string ApplicationServicesInterfacesNamespace = "AccountService.Domain.Interfaces.Services";
    ...
    /// <summary>
    /// Registers all application services in the AccountService.Application assembly.
    /// </summary>
    ...
    {
        var applicationAssembly = Assembly.Load("AccountService.Application")
